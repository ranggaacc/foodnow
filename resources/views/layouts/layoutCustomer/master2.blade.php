...
<body>
<img src="{{URL::asset('/image/coba3.jpg')}}" alt="gambar" class="bg hidden-print" />
    <div id="app">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if (Auth::guest())
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="font-family:roboto; color:#E6297D;">
                                      <b>LOGIN</b> 
                        ...
                        @elseif(Auth::user()->name=='admin')
                            <li><a style="font-family:roboto; color:#E6297D;" href="/dashboardAdmin"><span class="glyphicon glyphicon-dashboard"></span> Dashboard Admin</a></li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle uppercase " data-toggle="dropdown" role="button" aria-expanded="false" style="font-family:roboto; color:#E6297D;">
                        ...
                        {{-- USER BIASA --}}
                        @else
                            <li><a style="font-family:roboto; color:#E6297D;" href="/user"><span class="glyphicon glyphicon-home"></span> HOME</a></li>
                            <li><a style="font-family:roboto; color:#E6297D;" href="/save/{{ Auth::user()->id }} "><span class="glyphicon glyphicon-transfer"></span> TRANSACTION</a></li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle uppercase " data-toggle="dropdown" role="button" aria-expanded="false" style="font-family:roboto; color:#E6297D;">
                                    <strong>Hello!</strong> &nbsp;{{ Auth::user()->name }} 
                                    <span class="caret"></span>
